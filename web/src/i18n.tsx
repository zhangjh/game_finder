...
const zh = {
  ...
  searchHint:
    "提示：可以直接输入「我只有10分钟，想玩轻松的」这类自然语言需求，也可以搜「塔防」「双人」这类关键词",
...
const en: Record<I18nKey, string> = {
  ...
  searchHint:
    "Tip: describe what you want in plain language (\"10 minutes, something relaxing\"), or search keywords like \"tower defense\" or \"2 player\"",
